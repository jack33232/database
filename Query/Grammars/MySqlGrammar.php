...
class MySqlGrammar extends Grammar
{
    ...
    public function compileUpdateOnDuplicate(Builder $query, array $values, array $fields)
    {
        ...
        return "insert into $table ($columns) values $parameters ON 
DUPLICATE KEY UPDATE $update_fields";
    }

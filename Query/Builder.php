...
class Builder
{
    ...
    public function updateOnDuplicate(array $values, array $fields = [])
    {
        if (empty($values)) {
            return true;
        }
        ...
        if (empty($fields)) {
            throw new InvalidArgumentException('Missed update fields.');
        }
        ...
        $sql = $this->grammar->compileUpdateOnDuplicate($this, $values, $fields);
